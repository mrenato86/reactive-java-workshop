...
public class Exercise6 {
    ...
    public static void main(String[] args) {
        ...
        //List<String> results = ReactiveSources.unresponsiveFlux().collectList().block(Duration.ofSeconds(5));
        List<String> results_alt = ReactiveSources.unresponsiveFlux()
                .timeout(Duration.ofSeconds(5))
        ...
        System.out.println(results_alt);
